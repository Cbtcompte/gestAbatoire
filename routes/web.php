...
Route::get('/admin', function(){ return view('admin.dashboard');})->name('admin.dashboard')->middleware('auth');
...
Route::get('/facture/show/{facture}', [FactureController::class, 'show'])->name('facture.show')->middleware('auth');
Route::delete('/facture/destroy/{facture}', [FactureController::class, 'destroy'])->name('facture.destroy')->middleware('auth');
...
Route::get('/pdf/reglement/{facture}', [PdfController::class, 'reglement'])->name('facture.reglement')->middleware('auth');
...
Route::get('/detail/{facture}', [PayementController::class, 'detailPayement'])->name('paiement.details')->middleware('auth');
